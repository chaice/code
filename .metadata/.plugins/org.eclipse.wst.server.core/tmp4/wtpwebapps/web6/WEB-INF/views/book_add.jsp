	...
	<div class="col-md-8 col-md-offset-2">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form class="form-horizontal" role="form" action="/book_add1" method="post">
					<div class="form-group">
						<label class="col-md-4 control-label">书号</label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="code" placeholder="请输入书号！">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="title" placeholder="请输入书名！">
							<span class="help-block" style="display: none;"> </span>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="total" placeholder="请输入总数！">
							<span class="help-block" style="display: none;"> </span>
						</div>
